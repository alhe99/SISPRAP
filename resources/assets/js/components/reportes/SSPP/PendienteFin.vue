          ...
          <div class="panel-body">
            <div class="row md-radio">
              <div class="col-md-12 text-center">
                <h4 class="font-weight-bold" v-if="proceso_id == 1">Reporte De Estudiantes Que Están Pendientes de Finalizar Servicio Social</h4>
                <h4 class="font-weight-bold" v-if="proceso_id == 2">Reporte De Estudiantes Que Están Pendientes de Finalizar Práctica Profesional</h4>
              </div>
            </div>
          </div>
        </div>
 ...
 methods: {
  ...
  sendParameterToMethod() {
    ...
    if(me.trimestral == true)
     var url = route('reportePenFin',{'proceso_id':me.proceso_id,'meses': [me.trimestre.value],'tipoRepo':me.tipoRepo})
   else if(me.mensual == true)
    var url = route('reportePenFin',{'proceso_id':me.proceso_id,'meses': [me.valuesMonth],'tipoRepo':me.tipoRepo})
  else if(me.anual == true)
    var url = route('reportePenFin',{'proceso_id':me.proceso_id,'tipoRepo':me.tipoRepo})
  window.open(url);
  me.clearData();
},
},
