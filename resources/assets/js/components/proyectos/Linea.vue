            ...
            <tbody>
              <tr v-for="proyectosdes in arrayProyectosDes" :key="proyectosdes.id">
                ...
                <td class="text-center">
                   <template>
                      <h4>
                       <span v-if="proyectosdes.estado == 0" class="badge badge-pill badge-danger">Desactivada</span>
                       </h4>
                    </template>
                </td>
                <td class="text-center">
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default">
              <div class="panel-body">
                <fieldset >
                   <legend class="text-center">Actualizar Proyecto</legend>
                </fieldset>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 col-xs-12 col-lg-12">
            <br><label for="nombre">Nombre del proyecto</label>
          ...
          <div class="col-md-12 col-sm-12 col-lg-12">                                       
           <form-wizard  v-if="proceso == 2"
                ...
                <tab-content  v-for="proyecto in arrayActivities" :key="proyecto.id"
                  ...
                  <mdc-button type="button" ref="myBtn" raised slot="next" @click="agregarActivi">Siguiente</mdc-button>
                  <mdc-button type="button" ref="btnEnd" raised slot="finish" @click="agregarActivi">Aceptar</mdc-button>
            </form-wizard>
  ...
  watch: {
    ...
    carrerasProy: function() {
          ...
          if(this.carrerasProy.length >= 0){
            for (let index = 0; index < carrerasProy.legend; index++) {
              console.log("Hecho");
         }
      }
