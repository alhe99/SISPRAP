            ...
            <div class="col-md-1 col-sm-1 col-lg-1 text-center">
               <div class="btn-group pull-xs-right">
                  ...
                  <div class="dropdown-menu dropdown-menu-right"  aria-labelledby="mw2">
                     ...
                     <button v-if="user.id == 0 || user.rol_id == 3" class="dropdown-item d-block menu" type="button" @click="abrirModalID()"><i class="mdi mdi-delete-empty"></i> Instituciones Desactivadas</button>
                  </div>
               </div>
            </div>
         </div>
                        ...
                        <tr v-for="institucion in arrayInstitucion" :key="institucion.id">
                           ...
                           <td class="text-center">
                              ...
                              <template v-if="institucion.estado">
                                 <button v-if="user.id == 0 || user.rol_id == 3" type="button" @click="desactivarInstitucion(institucion.id)" class="button red" data-toggle="tooltip" title="Desactivar institución"><i class="mdi mdi-delete-variant"></i></button>
                              </template>
                              ...
                              <button v-if="user.id == 0 || user.rol_id == 3" type="button" @click="verMasInfo(institucion)" class="button secondary " data-toggle="tooltip" title="Ver más información"><i class="mdi mdi-playlist-plus"></i></button>
                           </td>
                        </tr>
                     </tbody>
                  </table>
                        ...
                        <div class="panel-body">
                           <div class="row">
                              <div class="col-md-12 mt-3">
                                 <h4 class="align-baseline font-weight-bold">Listado de Supervisores Registrados</h4>
                                 <br>
                              </div>
                              <div class="col-md-12">
                                 <div class="table-responsive">
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <div class="col-md-12 col-xs-12 col-lg-12">
                        ...
                        <br>
                        <v-select label="label" v-model="departamento_id" :onChange="watchDepa" placeholder="Seleccione un departamento" :options="arrayDepartamentos">
                  ...
                  <div class="row">
                     <div class="col-md-12 col-xs-12 col-lg-12" v-if="departamento_id !== null">
                        ...
                        <br>
                        <v-select label="label" v-model="municipio_id"  placeholder="Seleccione un municipio"  :options="arrayMunicipios">
                           <span slot="no-options">
                           No hay datos disponibles
                           </span>
                        </v-select>
                  ...
                  <div class="row">
                     <div class="col-md-12 col-xs-12 col-lg-12">
                        ...
                        <br>
                        <v-select label="label" v-model="sector_id" placeholder="Seleccione un sector de la institucion"  :options="arraySectores">
                           <span slot="no-options">
                           No hay datos disponibles
                           </span>
                        </v-select>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div v-show="!images.length">
                                                               ...
                                                               <div class="file-input">
                                                                  ...
                                                                  <input length="1024" type="file" id="file" @change="onInputChange" multiple>
                                                               </div>
                                                            </div>
