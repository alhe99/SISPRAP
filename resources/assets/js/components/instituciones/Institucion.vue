<template>
  ...
  <div class="col-lg-12 col-md-12">
    ...
    <div class="card" v-if="proceso !== 0 && verCard == 1">
        ...
        <div class="row">
          <div class="col-md-6 col-sm-12 col-lg-6">
            <h3
              ...
              v-if="proceso == 1"
            >Listado de instituciones de Servicio Social</h3>
            <h3
              class="align-baseline font-weight-bold"
              v-if="proceso == 2"
            >Listado de instituciones de Practica Profesional</h3>
          </div>
          <div class="col-md-5 col-sm-12 col-lg-5">
            <div class="form-group row">
              <mdc-textfield
                type="text"
                class="col-md-12"
                @keyup="listarInstitucion(1,proceso,buscar)"
            ...
            <div class="btn-group pull-xs-right">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="mw2">
                <button
                  ...
                  type="button"
                  @click="abrirModal('institucion','registrar')"
                >
                  <i class="mdi mdi-plus-box"></i> Registrar Institución
                </button>
                <button class="dropdown-item d-block menu" type="button" @click="abrirModalID()">
                  <i class="mdi mdi-delete-empty"></i> Instituciones Desactivadas
                </button>
              </div>
            </div>
          </div>
            ...
            <div class="table-responsive">
              <table id="myTable" class="table table-striped table-bordered table-mc-light-blue">
                ...
                <tbody>
                  <tr v-for="institucion in arrayInstitucion" :key="institucion.id">
                    ...
                    <td
                      class="text-center"
                      v-if="institucion.email != null"
                    >{{institucion.email | truncate(15)}}</td>
                    ...
                    <td class="text-center">
                      <button
                        type="button"
                        @click="abrirModal('institucion','actualizar',institucion)"
                        class="button blue"
                        data-toggle="tooltip"
                      ...
                      <template v-if="institucion.estado">
                        <button
                          type="button"
                          @click="desactivarInstitucion(institucion.id)"
                          class="button red"
                          data-toggle="tooltip"
                      ...
                      <button
                        type="button"
                        @click="openModalSupervisores(institucion)"
                        class="button dark"
                        data-toggle="tooltip"
                        title="Supervisores"
                      >
              ...
              <nav>
                <ul class="pagination">
                  ...
                  <small
                    v-show="arrayInstitucion.length != 0"
                    class="text-muted pagination-count"
                    v-text=" '(Mostrando ' + arrayInstitucion.length + ' de ' + pagination.total + ' registros)'"
                  ></small>
                </ul>
              </nav>
            </div>
      ...
      <div
        class="modal fade"
        :class="{'mostrar' : modalSupervisores }"
        role="dialog"
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <button
                class="btn btn-primary h5 font-weight-bold text-dark text-capitalize"
                type="button"
              ...
              >
                <i style="margin-bottom: -10px" class="mdi mdi-playlist-plus i-crud"></i>&nbsp;Agregar Supervisores
              </button>
                      ...
                      <div class="row m-1">
                        ...
                        <div class="col-md-12 text-right">
                          <button
                            v-if="!updSupervisor"
                            type="button"
                            @click="registrarSupervisor"
                            class="button blue text-right"
                            :class="[nombreSupervisor == '' ? 'disabled' : '']"
                            :disabled="nombreSupervisor == '' "
                          >Guardar Datos</button>
                          
                          <button
                            v-if="updSupervisor"
                            type="button"
                            @click="actualizarSupervisor"
                            class="button blue text-right"
                            :class="[nombreSupervisor == '' ? 'disabled' : '']"
                            :disabled="nombreSupervisor == '' "
                  ...
                  <div class="panel-body">
                    <div class="row">
                      <div class="col-md-12 mt-3">
                        <h4
                          class="align-baseline font-weight-bold"
                        >Listado de Supervisores Registrados</h4>
                        <br>
                      </div>
                      <div class="col-md-12">
                        <div class="table-responsive">
                          <table
                            id="myTable"
                            class="table table-striped table-bordered table-mc-light-blue"
                          >
                            <thead class="thead-primary">
                              <tr>
                                <th>Nombre</th>
                            ...
                            <tbody>
                              <tr
                                v-if="arraySupervisores.length > 0"
                                v-for="item in arraySupervisores"
                                :key="item.id"
                              >
                                <th v-text="item.nombre"></th>
                                <th
                                  v-text="item.no_telefono == null ? '------' : item.no_telefono "
                                  class="text-center"
                                ></th>
                        ...
                        <div v-if="arraySupervisores.length == 0" class="row">
                          <div class="col-md-12 text-center">
                            <div
                              class="alert font-weight-bold alert-warning h6 text-center col-md-12"
                              role="alert"
                            >No hay supervisores registrados en esta institución</div>
                          </div>
                        </div>
                      </div>
                    </div>
            ...
            <div class="modal-body">
              <div class="bmd-form-group bmd-collapse-inline pull-xs-right">
                ...
                <span id="collapse-search" class="collapse">
                  <input
                    v-model="buscarID"
                    @keyup="listarInstitucionDes(1,proceso,buscarID)"
                    class="form-control"
                    data-toggle="tooltip"
                    title="Buscar Registros"
                    type="text"
                    id="search"
                    placeholder="Ingrese Nombre de la Institución/Empresa"
                  >
                </span>
              </div>
              <br>
                        ...
                        <tr v-for="instituciondes in arrayInstitucionDes" :key="instituciondes.id">
                          ...
                          <td class="text-center">
                            <template>
                              <button
                                type="button"
                                @click="activarInstitucion(instituciondes.id)"
                      ...
                      <ul class="pagination">
                        <li class="page-item" v-if="paginationInstiDes.current_page > 1">
                          <a
                            class="page-link font-weight-bold"
                            href="#"
                            @click.prevent="cambiarPaginaPID(paginationInstiDes.current_page -1,proceso,buscar)"
                          >Ant</a>
                        </li>
                        <li
                          class="page-item"
                        ...
                        <li
                          class="page-item"
                          v-if="paginationInstiDes.current_page < paginationInstiDes.last_page"
                        >
                          <a
                            class="page-link font-weight-bold"
                            href="#"
                        ...
                        <small
                          v-show="arrayInstitucionDes.length != 0"
                          class="text-muted pagination-count"
                          v-text=" '(Mostrando ' + arrayInstitucionDes.length + ' de ' + paginationInstiDes.total + ' registros)'"
                        ></small>
                      </ul>
                    </nav>
                  </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="row">
                <div class="col-md-12 col-xs-12 col-lg-12">
                  <br>
                  <label for="email">Seleccione un Departamento*</label>
                  <br>
                  <v-select
                    label="label"
              ...
              <div class="row">
                <div class="col-md-12 col-xs-12 col-lg-12">
                  <br>
                  <label for="email">Seleccione un Sector de la Institución*</label>
                  <br>
                  <v-select
                    label="label"
                    v-model="sector_id"
                    placeholder="Seleccione un sector de la institucion"
                    :options="arraySectores"
                  >
                    <span slot="no-options">No hay datos disponibles</span>
                  </v-select>
                </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <button
                    ...
                    :class="[validate == true ? 'disabled' : '']"
                    v-if="tipoAccion==1"
                    class="button blue"
                    @click="registrarInstitucion"
                    dense
                  >
                    <i class="mdi mdi-content-save"></i>&nbsp;Guardar Institución
                  </button>
                  <button
                    type="button"
                    :disabled="validate == true"
                    ...
                    dense
                  >
                    <i class="mdi mdi-content-save"></i>&nbsp;Actualizar Institución
                  </button>
                </div>
              </div>
            </div>
                    ...
                    <div class="panel-body">
                      <div class="row">
                        <div class="col-md-12">
                          <fieldset>
                            <legend
                              class="text-center font-weight-bold h5"
                            >Datos completos de la institución</legend>
                            <div class="panel panel-default">
                              <div class="panel-body" id="info">
                                ...
                                <div
                                  v-for="sector in institucion.sector_institucion"
                                  :key="sector.id"
                                >
                                  <h5 v-show="sector.length > 4">
                                    <strong>Sector de la institucion:</strong>
                                    {{ sector }}
                                  </h5>
                                </div>
                                <h5>
                          ...
                          <div class="row">
                            <div class="col-md-6 col-sm-12 col-lg-6">
                              <h3
                                class="align-baseline font-weight-bold"
                              >Proyectos de la institucion {{ institucion["nombre"] }}</h3>
                            </div>
                            <div class="col-md-6 col-sm-12 col-lg-6">
                              <div class="form-group row">
                                <mdc-textfield
                                  type="text"
                                  class="col-md-12"
                                  @keyup="getProyectosInsti(institucion.id,1,buscar,proceso)"
                                  label="Buscar por Nombre del proyecto"
                                  v-model="buscar"
                                ></mdc-textfield>
                              </div>
                            </div>
                              ...
                              <div class="table-responsive">
                                ...
                                >
                                  ...
                                  <tbody>
                                    <tr v-for="proyecto in arrayProyectos" :key="proyecto.id">
                                      ...
                                      <td
                                        class="text-center"
                                        v-text="proyecto.created_at.substring(0,10)"
                                      ></td>
                                      <td
                                        class="text-center"
                                        v-if="proceso == 2"
                                        v-text="proyecto.carre_proy[0].nombre"
                                      ></td>
                                      <td class="text-center">
                                        <template>
                                          <h4>
                                            <span
                                              ...
                                              class="badge h1 badge-pill badge-primary"
                                            >Supervisado</span>
                                            <span
                                              v-else
                                              class="badge badge-pill badge-danger"
                                ...
                                <nav>
                                  <ul class="pagination">
                                    ...
                                    <small
                                      v-show="arrayProyectos.length != 0"
                                      class="text-muted pagination-count"
                                      v-text=" '(Mostrando ' + arrayProyectos.length + ' de ' + pagination.total + ' registros)'"
                                    ></small>
                                  </ul>
                                </nav>
                                  ...
                                  <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        ...
                                        >{{titleMRS + modalsTitle | truncate(55)}}</h4>
                                        <button
                                          type="button"
                                        ...
                                        <div class="form-group row">
                                          <div class="col-md-12 col-sm-6 col-lg-12">
                                            <datetime
                                              ...
                                              placeholder="Fecha en la que fue realizada la supervisión"
                                            ></datetime>
                                          </div>
                                        </div>
                          ...
                          <div v-if="arrayProyectos.length == 0" class="row">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                              <div
                                class="alert alert-warning h6 font-weight-bold text-center"
                                role="alert"
                                v-text="'No existen proyectos registrados en esta institución'"
                              ></div>
                            </div>
                          </div>
                        </div>
                      ...
                      <button
                        type="button"
                        @click="back()"
                        class="btn btn-primary text-capitalize font-weight-bold"
                        data-toggle="tooltip"
                        id="back"
                        title="Regresar"
                      >
                        <i class="mdi mdi-chevron-double-left"></i>Regresar
                      </button>
                    </div>
                  </div>
                </div>
        ...
        if (result.value) {
          ...
          axios.get(urlValidate).then(function(response) {
            ...
            if (
              ...
              axios
                .put("institucion/supervisor/update", {
                  id: me.supervisor_id,
                  nombre: me.nombreSupervisor,
                  telefono: me.telefonoSupervisor
                })
    ...
    deleteSupervisor(id) {
      swal({
        ...
        if (result.value) {
          ...
          me.loadSpinner = 1;
          axios
            .put("/institucion/supervisor/eliminar/" + id)
            .then(function(response) {
              me.getSupervisores();
              swal(
                "Eliminado!",
