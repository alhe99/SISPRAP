          ...
          <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <tbody>
                 <tr v-for="item in arrayStudents" :key="item.id">
                    ...
                    <td class="text-center">
                      <button type="button" class="button secondary " @click="getMoreInfo(item.id)" data-toggle="tooltip" title="Registrar Pago"><i class="mdi mdi-square-inc-cash"></i> Registrar Pago</button>
                  </td>
                </tr> 
              </tbody>
            </table> 
            <nav>
              ...
              <div class="modal-dialog modal-lg">
                ...
                <div class="row"> 
                  <div class="col-md-12">
                  <button type="button" id="btnSave" @click="savePay()" class="button blue">Guardar Datos</button>
                  <button type="button" @click="cerrarModal()" class="button red">Cerrar</button>
                  </div>
                </div>
                </div>
              </div>
...
export default {
    ...
    savePayArancel(no_fac,estudiante_id,tipobeca_id) {
