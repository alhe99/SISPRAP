  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 wow animated fadeInLeft" data-wow-delay=".2s">
        <h1 class="section-title text-center">Formulario de inscripción de proyecto</h1>
    </div>
    <div class="col-md-12">
...
<div class="row">
    <div class="col-md-4 wow animated fadeInRight" data-wow-delay=".2s">
        <div class="form-group control-label">
          ...
          <input class="form-control" id="fecha_ini" type="date" name="fecha_ini" >
...
<div class="row text-center">
  ...
  <br>
  <div class="col-md-6 wow animated fadeInRight" data-wow-delay=".2s">
      <button class="btn btn-info text-capitalize btn-lg font-weight-bold">Cancelar</button>
  </div>
</div>
</form>
</div>
