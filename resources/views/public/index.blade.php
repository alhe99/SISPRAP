...
<br> @if (Auth::user()->estudiante->supero_limite == 1)
...
<div class="row">
  ...
  @endif @elseif(count($proyectos) == 0) @if (Auth::user()->estudiante->proceso[0]->id == 2 and Auth::user()->estudiante->nivel_academico_id
  == 1)
  ...
  @endif @elseif(Auth::user()->estudiante->proceso[0]->id == 2 and Auth::user()->estudiante->nivel_academico_id == 1 and Auth::user()->estudiante->articulado
  == false)
  <div class="alert alert-success" role="alert">
    <hr>
