               ...
               <div width="8">
                 ...
                 <div class="row ">
                    ...
                    <table class="col-md-12" border="1" cellpadding="4" cellspacing="4" style="margin-top:;">
                            <tr>
                                <td>Nombre del estudiante: <label style="margin-left:350px;">Carnét Nº:</label> </td>
                            </tr>
                            <tr>
                                <td>Carrera: </td>
                            </tr>
                            <tr>
                                <td >Nombre de la institución donde realizará el proyecto </td>
                            </tr>
                            <tr>
                                <td>Nombre del proyecto <label style="font-size: xx-small;">(segun perfil)</label> </td>
                            </tr>
                    </table>
          <div class="row">
