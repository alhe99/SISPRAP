            ...
            <div class="col-md-12"><br>
               ...
               <div width="8">
                ...
                <table   cellpadding="7" border="1" class="col-md-12" class="col-md-12" cellspacing="2" style=" margin-top:-30px;"  >
                    <tr class="col-md-12">
                        <td  colspan="5" style=" font-size:small; width:150px;" >Nombre:</td>
                        <td  colspan="1" style=" font-size:small; "  >Carnet Nº:</td>
                    </tr>
                     <tr>
                        <td  colspan="6" style=" font-size:small;">Carrera:</td> 
                    </tr>
               </table>
               </div>  
                <div class="row">
                ...
                <table cellpadding="7" cellspacing="0" class="col-md-12 " border="1" style=" margin-left: 5px; margin-right:-5px; ">
                    <tr>
                        <td   style="font-size:small; padding-top: 0px;">Nombre:<br><br><br></td>
                    </tr>
                </table>
            </div>
              ...
              <div>
                ...
                <table cellpadding="7" cellspacing="5" class="col-md-12 " border="1" style="padding-top:-340px; margin-left: 5px; margin-right:-5px;" >
                    <tr>
                        <td style="font-size:small; padding-top: 0px;  width:400px; " colspan="4">Nombre <label style="font-size: x-small;">(segun perfil):</label><br><br></td>
                        <td style="font-size:small; padding-top: 0px; " class="text-center" colspan="2">Horas Realizadas:<br><br></td>
                    </tr>
                    <tr>
                        <td style="font-size:small; padding-top: 0px; " colspan="6">Descripción de actividades realizadas:<br><br><br><br><br><br><br><br><br><br></td>
                        
                    </tr>
                    <tr>
                        <td style="font-size:small; padding-top: 0px; " colspan="6">Nombre del supervisor:<br><br></td>
