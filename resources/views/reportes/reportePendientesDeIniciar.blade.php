...
<head>
    ...
    <title>Estudiantes Pendientes de Iniciar {{$procesoTitulo == "SERVICIO SOCIAL" ? 'Servicio Social' : 'Práctica Profesional'}}{{" ".$anio}}</title>
   ...
   <div class="row m-5 ">
    <div class="row">
        <div class="col-md-12">
            ...
            <p class="text-center font-weight-bold"><u>INFORME DE ESTUDIANTES PENDIENTES DE INICIAR {{ $procesoTitulo }} DEL {{ $anio}}</u></p><br>
            @if ($tipo == 'M')
